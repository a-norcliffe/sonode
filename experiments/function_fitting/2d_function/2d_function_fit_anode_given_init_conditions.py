...
if __name__ == '__main__':
    ...
    filename = 'results./anode('+str(args.extra_dim)+')./given_initial_conditions./'+str(args.experiment_no)+'./'
   ...
   # making sampled data to fit
    ...
    if args.extra_dim == 1:
        ...
        np.save(filename+'learnt_x_aug.npy', aug_x)
        np.save(filename+'learnt_y_aug.npy', aug_y)
