...
class init_a(nn.Module):
    
    def __init__(self, dim, nhidden):
        super(init_a, self).__init__()
...
if __name__ == '__main__':
    ...
    filename = 'results./anode('+str(args.extra_dim)+')./learn_initial_conditions./'+str(args.experiment_no)+'./'
    data_dim = 2
   ...
   # making sampled data to fit
    ...
    feature_layers = [init_a(2, nhidden) ,ODEBlock(ODEfunc(dim, nhidden), samp_ts, ids)]
